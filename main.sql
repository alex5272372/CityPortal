...
CREATE TABLE req_reqList (
	...
	, CONSTRAINT FK_REQ_MI_DATA_ID_REF_REQ FOREIGN KEY (MI_DATA_ID) REFERENCES req_reqList(ID)	
...
CREATE TABLE req_subDepart (
	...
	, CONSTRAINT FK_REQ_SUBDEPART_MI_DELETEUSER_REF_USR FOREIGN KEY (MI_DELETEUSER) REFERENCES uba_user(ID)	
);
--
CREATE TABLE req_user (
	...
	phone VARCHAR(255) NOT NULL, --User Phone
	website VARCHAR(255) NOT NULL --User Website
);
--
...
--
CREATE INDEX IDX_REQ_MI_DATA_ID ON req_reqList(MI_DATA_ID) ;
--
...
--
CREATE INDEX IDX_REQ_DTODD ON req_reqList(MI_DATETO) ;
--
